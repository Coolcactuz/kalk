...
#include "View/specialized view hierarchy/specialized_view.h"
...
QT_MOC_LITERAL(4, 39, 13) // "goBack_CStart"

    },
    "specialized_view\0sendData\0\0std::string\0"
    "goBack_CStart"
};
...
void specialized_view::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendData((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        case 1: _t->goBack_CStart(); break;
        default: ;
        }
        ...
        {
            typedef void (specialized_view::*_t)(std::string );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&specialized_view::sendData)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&specialized_view::goBack_CStart)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void specialized_view::sendData(std::string _t1)
{
...
// SIGNAL 1
void specialized_view::goBack_CStart()
{
